...
import {
  UpdateCategoryByIdRequestDto,
  UpdateCategoryByIdResponseDto,
} from '../dto/category.update-by-id.dto';
...
export class CategoriesApiService {
  ...
  getCategory = (id: string) => {
    return this.http.get<GetCategoryResponseDto>(
      `${this.base}/categories/${id}`,
    );
  };

  createCategory = (data: CreateCategoryRequestDto) => {
    return this.http.post<CreateCategoryResponseDto>(
  ...
  updateCategory = (id: string, data: UpdateCategoryByIdRequestDto) => {
    return this.http.put<UpdateCategoryByIdResponseDto>(
      `${this.base}/categories/${id}`,
      { data },
    );
  };
